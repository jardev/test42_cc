# Django settings for tests_42cc project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'tests_42cc.db',         # Or path to database file if using sqlite3.
...
SECRET_KEY = '2ipl_*anzspx5n%ay7fv082mgr&_$tedsuepy#@xlug&)e-ktn'
